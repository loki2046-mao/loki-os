...
{id:'coder',title:'Vibe coder',eyebrow:'制作通行证',icon:'↗',color:'blue',body:`<span class="object-kicker">制作中 / 想法需要一个落点</span><h3>从「想要」，<br>到能打开。</h3><p>做 AI 产品、写小工具、把常用方法留成 Skill。作品节目单里，可以看到实际界面和当前进展。</p><div class="pass-strip">LOKI <span>想法 → 制作 → 检查</span></div><div class="role-routes"><a href="#works">看十一件作品 <span>翻到节目单 →</span></a><a href="https://github.com/loki2046-mao" target="_blank" rel="noopener">Loki 的 GitHub <span>个人主页 ↗</span></a><a href="#skills-building">构建方法 <span>3 个条目 →</span></a></div>`},
