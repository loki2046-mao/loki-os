...
const motifs={visual:['视觉','一眼看过去，就停住了。','海报折页'],writing:['写作','这句话，我写给你看。','歌词内页'],knowledge:['研究','先别急着下结论。','注解册'],building:['构建','想要的东西，我自己做一个。','后台通行证'],personal:['个人','我偏爱的，都收着。','收藏唱片']};
const hooks={ 'interface-system':['工具天天用，为什么不能长成我喜欢的样子？','换肤'], 'perspective-distillation':['换一道没见过的题，还能认出这个人的判断吗？','判断'],inkpanda:['写到后面，前面的伏笔谁来记？','长篇'], 'daily-insight':['读完以后，我究竟留下了什么？','洞见'],'loki-health':['记录自己的身体，也得守住自己的隐私。','节律'],'loki-ebook-converter':['我只想转一本书，不想先学会一个复杂工具。','转换'],lian:['喜欢的歌，能不能在刚好的时候回你一句？','偏爱'],'qichi-life-os':['不想靠意志力坚持的事，怎么让它每天发生？','复盘'],'edu-content-line':['一门课的讲法，能不能搬进另一门课？','骨架'],'ai-career-compass':['先别急着焦虑，先看下一步该做什么。','行动'],'loki-assistant':['记忆怎么存、存成什么样，我想自己说了算。','助手']};
