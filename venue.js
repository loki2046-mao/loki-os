...
function dress(){
const footer=document.querySelector('.publication-footer');if(footer&&!footer.querySelector('.encore-scene')){footer.classList.add('encore-footer');footer.insertAdjacentHTML('afterbegin',`<div class="encore-scene"><div><span class="encore-kicker">SAME STAGE / MORE STORIES</span><h2>这一页看完，<br>还有下一场。</h2><p>做过的事都留在这儿了，<br>下一件也已经在做。</p><button class="encore-map">看看下一站 ↗</button></div><div class="goodbye-sticker" aria-hidden="true"></div><span class="encore-tag" aria-hidden="true">SEE YOU<br>NEXT TIME!</span></div>`);footer.querySelector('.encore-map').onclick=openMap}
if(!reading)return;
...
const words={ink:['WRITER’S ROOM','长篇创作 · 正文与前情','上一章的人和事，我接着往下写。'],visual:['PRINT ROOM','视觉试印 · 正面与背面','同一张图的正反两面，我都看一眼。'],build:['TOOL WORKSHOP','转换工坊 · 输入与带走','入口只有一个，里面的步骤都摊开了。']}[kind];
